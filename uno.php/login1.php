...
if ($reg['color'] == "rojo") {
  echo "<font color = 'red'> Esto es un color $color </font>";
  ...
  echo "<font color = 'blue'> Esto es un color $color </font>";   echo "<br>";
  echo "<p> Su color preferido es el  <font color = 'blue'> " . $reg['color'].  "</font> </p> ";
  echo "<br>";
